  ...
  <header class="sticky-top" data-bs-spy="scroll" data-bs-offset="50">
    <nav>
      <div class="container-fluid d-flex justify-content-evenly">
        ...
        <a href="login.php" class="hbtn btn" role="button">LOGIN<i class="bi bi-door-open"></i></a>
      </div>
    </nav>
  </header>
    ...
    <div class="col-md-4" data-aos="fade-right">
        ...
        while($row=mysqli_fetch_assoc($result_a)){
          ...
          <div class='aboutxt'>
            <h1>$aname</h1>
          <h3>$arole</h3>
          <a href='$cv' download='assets/img/$cv'><button type='button' class='btn btnsub w-100'><i class='bi bi-download'> Download CV</i></button></a>
          </div>
          ";
        }

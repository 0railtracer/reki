...
if(isset($_POST['incon'])){
    ...
    $select_query="SELECT * FROM `contact` WHERE conadd='$conadd'";
    $result_select=mysqli_query($con,$select_query);
    $number=mysqli_num_rows($result_select);
    if($number>0){
        echo "<script>alert('Contact already exists.')</script>";
    }else{
        $insert_query="INSERT INTO `contact`(conadd) VALUES ('$conadd')";
    ...
    <div class="col-md-6">
      <form action="" method="POST">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" placeholder="Email address" aria-label="default input example" name="cadd">
        </div>

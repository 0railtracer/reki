...
$selects="SELECT * FROM `skills` WHERE skid=$skid";
...
if(isset($_POST['inski'])){
  ...
  $selects="UPDATE `skills` SET skid=$skid, sname='$sname', sper='$sper' WHERE skid=$skid";
  $results=mysqli_query($con,$selects);
  ...
  <section id="skills" style="height: 85vh;">
    ...
    <form action="" method="POST">
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="text" value="<?php echo $sname; ?>" aria-label="default input example" name="skiname">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label text-dark fw-bold fs-3 font-monospace">Percent</label>
            <input class="form-control" type="text" value="<?php echo $sper; ?>" aria-label="default input example" name="skiper">
        </div>
        <a href="admindash.php#ski"><input type="button" class="btn w-100 btn-dark m-1 rounded-0" value="Back"></a>
